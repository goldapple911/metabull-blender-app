...
def transfer_weight_verts(object=None, dict=None, list=None, target_group_name=None):
    for vert in object.data.vertices:
        ...
        for grp in vert.groups:
            ...
            transfer_weight(object=object, vertice=vert, vertex_weight=grp.weight, group_name=grp_name, dict=dict, list=list, target_group_name=target_group_name)
...
def copy_vgroup(object=None, dict=None):
